...
ShaderResource::ShaderResource(GUID guid)
    : m_guid(guid), m_vertexShader(ShaderType::VERTEX), m_pixelShader(ShaderType::PIXEL)
{
}
...
MaterialResource::MaterialResource(GUID guid, GUID shader) : m_guid(guid), m_shader(nullptr)
{
